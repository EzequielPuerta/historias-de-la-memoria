...
<script>
    ...
    onMount(async () => {
        try {
            const response = await fetch('api/murders-and-kidnappings-by-month-and-year/', {
                method: 'GET'
            });
...
<canvas id="murdersAndKidnappingsByMonthAndYearChart" width="800" height="400"></canvas>
